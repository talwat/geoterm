...
msgpack_unpack_func(int, _execute)(
    msgpack_unpack_struct(_context) * ctx, const char *data, size_t len, size_t *off
) {
    assert(len >= *off);
    {
        ...
        do {
            ...
            case MSGPACK_CS_HEADER:
                ...
                case 0xd7: // fixext 8
                    again_fixed_trail_if_zero(
                        MSGPACK_ACS_EXT_VALUE, (1 << (((unsigned int)*p) & 0x03)) + 1, _ext_zero
                    );
                case 0xd8: // fixext 16
                ...
                again_fixed_trail_if_zero(
                    MSGPACK_ACS_STR_VALUE, ((unsigned int)*p & 0x1f), _str_zero
                );
            ...
            default:
                ...
                case MSGPACK_CS_EXT_8:
                    again_fixed_trail_if_zero(
                        MSGPACK_ACS_EXT_VALUE, (*(uint8_t *)n) + 1, _ext_zero
                    );
